    ...
    return TCurvedEdgeWidget(
      child: Container(
        ...
        child: SizedBox(
          ...
          /// -- if [size.isNotFinite: is not true is Stack], error occurred README.md file at
          child: Stack(
            children: [
              ...
              Positioned(
                  top: 10,
                  right: 0,
                  child: TCircularContainer(backgroundColor: TColors.TextWhite.withOpacity(0.1),child: child,)),
            ],
          ),
        ),
      ),
