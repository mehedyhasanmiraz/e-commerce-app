...
class TTextTheme{
  ...
  static TextTheme darkTextTheme = TextTheme(
      ...
      headlineSmall: TextStyle().copyWith(fontSize: 18,fontWeight: FontWeight.w400,color: Colors.white),
    ...
    labelMedium: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.normal,color: Colors.white.withOpacity(0.5)),
  );
}